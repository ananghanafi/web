            ...
            <v-card class="ra-0" fill-height>
                ...
                <v-card-text class="pa-0">
                    ...
                    <v-layout column v-else>
                        <v-list v-if="file_val">
                            <v-list-tile avatar>
                                ...
                                <v-list-tile-content>
                                    <v-list-tile-title>{{file_val.name}}</v-list-tile-title>
                                </v-list-tile-content>
                    ...
                    <v-layout column class="py-2 px-4">
                        <v-text-field v-if="options.category" v-model="category" label="Kategori"></v-text-field>
                        <v-text-field
                ...
                <v-card-actions>
                    <v-btn v-if="!uploading" flat @click="browseImg">Browse</v-btn>
                    <v-spacer></v-spacer>
                    <v-btn
