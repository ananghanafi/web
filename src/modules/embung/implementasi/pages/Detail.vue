                        ...
                        <v-tabs v-model="tab" fixed>
                                            ...
                                            <v-layout v-if="doc" row wrap>
                                                    ...
                                                    <v-layout row wrap>
                                                        <v-flex md12>
                                                            <v-card color="secondary" tile>
                                                                <v-card-text>PELAKSANAAN PEMBANGUNAN EMBUNG</v-card-text>
                                                            </v-card>
                                                        </v-flex>
                                                        <v-flex md4>
                                                ...
                                                <v-flex md6>
                                                    ...
                                                    <v-layout row wrap class="pl-2">
                                                        <v-flex md12 pb-4>
                                                            <MiniMap pRef="embung" :doc="doc" :phu="doc ? doc.phu : null" title="LOKASI KEGIATAN" />
                                                        </v-flex>
                                                        <v-flex md12>                        
                                                            <v-autocomplete 
                                                                disabled
                            ...
                            <v-tab-item>
                                <v-card flat dense>
                                    ...
                                    <ProgressRealisasi module="embung" :item="impl"/>                                
                                </v-card>
                            </v-tab-item>
                            <!-- Dokumentasi -->
                            <v-tab-item>
                                <Gallery :item="impl" module="embung"/>
                            </v-tab-item>
                        </v-tabs>                    
                    </v-card-text>
                    <v-card-actions>
                        <v-spacer></v-spacer>
                            <v-btn color="primary" flat @click.native="$router.push({name:'embung_implementasi'})">Batal</v-btn>
...
export default {
    ...
    methods:{
        editImg(tag) {
            ...
            switch (tag) {
                ...
                case 5:
                    ...
                    op.func = 'embung/implementasi/uploadImage';
                    break;
                // case 6:
                //     op.img = null;
                ...
                case 7:
                    op.img = null;
                    op.func = 'embung/implementasi/uploadDocument';
                    op.options = {
                        description: true,
                        category: false,
                        preview: false,
        ...
        loadData(){
            return this.$store.dispatch('embung/implementasi/show', parseInt(this.$route.params.id))
            .then(res=>{
                this.impl = res
        ...
        save(){
            this.$store.dispatch('embung/implementasi/update', this.impl)
            .then(()=>{
                this.$success('Data Implementasi berhasil disimpan')
                this.$router.push({name:'embung_implementasi'})
            })
        },
    },
    computed:{
