    ...
    <v-layout column>
        <v-flex xs12>
            ...
            <v-card>       
                                                ...
                                                <v-layout row wrap>
                                                        <v-flex md12>
                                                            <v-card color="secondary" tile>
                                                                <v-card-text>PERENCANAAN PEMBANGUNAN EMBUNG</v-card-text>
                                                            </v-card>
                                                        </v-flex>
                                                    <v-flex md4>
                                                        <v-text-field
                ...
                <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="primary" flat @click.native="$router.push({name:'embung_rencana'})">Batal</v-btn>
...
export default {
    ...
    methods:{
        loadData(){
            return this.$store.dispatch('embung/perencanaan/show', parseInt(this.$route.params.id))
            .then(res=>{
                this.plan = res
        ...
        save(){
            this.$store.dispatch('embung/perencanaan/update', this.plan)
            .then(()=>{
                this.$success('Data Perencanaan berhasil disimpan')
                this.$router.push({name:'embung_rencana'})
            })
        }
    },
    computed:{
