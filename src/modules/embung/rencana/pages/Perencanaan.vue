...
export default {
    ...
    methods: {
        ...
        load(pg=1){
            this.loading = true
            this.$store.dispatch('embung/perencanaan/get',{...this.filter,page:pg})
            .then(res=>{
                // let index = 0
                // ada pagging
        ...
        edit(item){
            this.$router.push({name:'embung_rencana_detail', params : {id : item.id}})
        },
        approve(item){
            ...
            .then(()=>{
                return this.$store.dispatch('embung/perencanaan/approveReject',{id:item.generalActivity.id, is_approve : true})
            })            
            .then(()=>{
                this.load()
            })
        ...
        updateItems(item){
            return this.$store.dispatch('embung/perencanaan/updateItems',{
        ...
        reject(item){
            ...
            .then(()=>{
                return this.$store.dispatch('embung/perencanaan/approveReject',{id:item.generalActivity.id, is_approve : false})
            })            
            .then(()=>{
                this.load()
            })
