            ...
            <v-flex xs12>
                <v-card class="pb-3">
                    <v-card-title class="elevation-1 font-weight-bold">
                        PERENCANAAN KEGIATAN REVEGETASI
                    </v-card-title>
...
export default {
    ...
    data(){
        return {
            ...
            headers: [
                ...
                { text: 'Kode SKE', value: 'generalActivity.code', sortable: false},
    ...
    methods: {
        ...
        load(pg=1){
            this.loading = true
            this.$store.dispatch('revegetasi/perencanaan/get',{...this.filter,page:pg})
            .then(res=>{
                // let index = 0
                // ada pagging
        ...
        edit(item){
            this.$router.push({name:'revegetasi_rencana_detail', params : {id : item.id}})
        },
        approve(item){
            ...
            .then(()=>{
                return this.$store.dispatch('revegetasi/perencanaan/approveReject',{id:item.generalActivity.id, is_approve : true})
            })            
            .then(()=>{
                this.load()
            })
        ...
        updateItems(item){
            return this.$store.dispatch('revegetasi/perencanaan/updateItems',{
        ...
        reject(item){
            ...
            .then(()=>{
                return this.$store.dispatch('revegetasi/perencanaan/approveReject',{id:item.generalActivity.id, is_approve : false})
            })            
            .then(()=>{
                this.load()
            })
