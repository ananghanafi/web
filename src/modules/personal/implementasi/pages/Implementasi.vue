                    ...
                    >
                        <template slot="items" slot-scope="props">
                            <tr @click="props.expanded = !props.expanded">
                                ...
                                <td class="">{{ props.item.generalActivity.revegetationType.desc }}</td>
    ...
    data(){
        return {
            ...
            headers: [
                ...
                { text: 'Tindakan', value: 'generalActivity.revegetationType.desc' },
                ...
                { text: 'Anggaran', value: 'generalActivity.cost' },
                { text: 'Sumber Anggaran', value: 'generalActivity.fundingSource.id' },
                { text: '',sortable : false}
            ],
            items : [],
            list_province : [],
