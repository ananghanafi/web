                        ...
                        <v-tabs v-model="tab" fixed>
                                            ...
                                            <v-layout v-if="doc" row wrap="">
                                                ...
                                                <v-flex md6>
                                                    ...
                                                    <v-layout row wrap="" class="pl-2">
                                                        <v-flex md12 class="pb-4">
                                                            <MiniMap
                                                                pRef="bor"
                                                                :doc="doc"
                                                                :phu="doc ? doc.peatHydrologicalUnity : null"
                                            ...
                                            <v-layout v-if="doc" row wrap="">
                                                <v-flex md6>
                                                    ...
                                                    <v-layout row wrap="">
                                                        <v-flex xs12>
                                                            <v-card color="secondary" tile>
                                                                <v-card-text>HASIL PEMBANGUNAN</v-card-text>
                                                            </v-card>
                                                        </v-flex>
                                                        <v-flex md6>
                                                            <v-text-field
                                                                v-model="det.wellDepth"
                                                                label="Kedalaman Sumur Bor"
                                                                type="number"
                                                                suffix=" meter"
                                                            ></v-text-field>
                                                        </v-flex>
                                                        <v-flex md6>
                                                            <v-text-field
                                                                v-model="det.peatDepth"
                                                                label="Kedalaman Gambut"
                                                                suffix=" meter"
                                                            ></v-text-field>
                                                        </v-flex>
                                                        <v-flex md6>
                                                            <v-text-field
                                                                v-model="det.wellDebit"
                                                                label="Debit Sumur Bor"
                                                                suffix=" (L/s)"
                                                            ></v-text-field>
                                                        </v-flex>
                                                        <v-flex md6>
                                                            <v-text-field
                                                                v-model="det.dayaSemprotAir"
                                                                label="Daya Semprot Air"
                                                                suffix=" meter"
                                                            ></v-text-field>
                                                        </v-flex>
                                                    </v-layout>
                            ...
                            <v-tab-item>
                                <v-card flat dense>
                                    ...
                                    <ProgressRealisasi module="bor" :item="impl"/>                                
                                </v-card>
                            </v-tab-item>
                            <!-- Dokumentasi -->
                            <v-tab-item>
                                <Gallery :item="impl" module="bor"/>
                            </v-tab-item>
                        </v-tabs>
                    </v-card-text>
                    <v-card-actions>
                        ...
                        <v-btn
                            color="primary"
                            flat
                            @click.native="$router.push({name:'bor_implementasi'})"
                        >Batal</v-btn>
...
export default {
    ...
    methods: {
        ...
        editImg(tag) {
            ...
            switch (tag) {
                ...
                case 5:
                    ...
                    op.func = 'bor/implementasi/uploadImage';
                    break;
                // case 6:
                //     op.img = null;
                //     op.func = 'bor/implementasi/uploadGallery';
                //     op.options = {
                //         description: true,
                //         category: true,
                //     }
                ...
                case 7:
                    op.img = null;
                    op.func = 'bor/implementasi/uploadDocument';
                    op.options = {
                        description: true,
                        category: false,
                        preview: false,
        ...
        loadData() {
            return this.$store.dispatch('bor/implementasi/show', parseInt(this.$route.params.id))
                .then(res => {
                    this.impl = res
        ...
        save() {
            this.$store.dispatch('bor/implementasi/update', this.impl)
                .then(() => {
                    this.$success('Data Implementasi berhasil disimpan')
                    this.$router.push({ name: 'bor_implementasi' })
                })
        },
        cancel() {
