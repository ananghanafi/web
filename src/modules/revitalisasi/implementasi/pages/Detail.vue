                                            ...
                                            <v-layout v-if="doc" row wrap>
                                                    ...
                                                    <v-layout row wrap>
                                                        <v-flex md12>
                                                            <v-card color="secondary" tile>
                                                                <v-card-text>PELAKSANAAN REVITALISASI</v-card-text>
                                                            </v-card>
                                                        </v-flex>
                                                        <v-flex md4>
                                                            <v-text-field
                                                        ...
                                                        <v-flex md3 pr-3>
                                                            <v-text-field v-model="doc.r11Unit" type="number" label="Sumur Bor" suffix="unit"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md3 pr-3>
                                                            <v-text-field v-model="doc.r12Unit" type="number" label="Sekat Kanal" suffix="unit"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md3 pr-3>
                                                            <v-text-field v-model="doc.r13M" type="number" label="Penimbunan Kanal" suffix="meter"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md3 pr-3>
                                                            <v-text-field v-model="doc.r14Unit" type="number" label="Embung" suffix="unit"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md4 pr-3>
                                                            <v-text-field v-model="doc.r21Ha" type="number" label="Suksesi Alami" suffix="Ha"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md4 pr-3>
                                                            <v-text-field v-model="doc.r22Ha" type="number" label="Pengkayaan" suffix="Ha"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md4 pr-3>
                                                            <v-text-field v-model="doc.r23Ha" type="number" label="Penanaman Pola Maks" suffix="Ha"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md12>
                                                            <v-card color="secondary" tile>
                                                ...
                                                <v-flex md6>
                                                    ...
                                                    <v-layout row wrap pl-2 pb-2>
                                                        <v-flex md12>
                                                            <MiniMap pRef="revitalisasi" :doc="doc" :phu="doc ? doc.phu : null" title="LOKASI KEGIATAN"/>
                                                        </v-flex>
                                                        <v-flex md3>
                        ...
                        <!-- Progress Realisasi -->
                            <v-tab-item>
                                <v-card flat dense>
                                    ...
                                    <ProgressRealisasi module="revitalisasi" :item="impl"/>                                
                                </v-card>
                            </v-tab-item>
                        <!-- Dokumentasi -->
                            <v-tab-item>
                                <Gallery :item="impl" module="revitalisasi"/>
                            </v-tab-item>
                    </v-tabs>                    
                    </v-card-text>
                    <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="primary" flat @click.native="$router.push({name:'revitalisasi_implementasi'})">Batal</v-btn>
...
export default {
    ...
    methods:{
        editImg(tag) {
            ...
            switch (tag) {
                ...
                case 5:
                    ...
                    op.func = 'revitalisasi/implementasi/uploadImage';
                    break;
                // case 6:
                //     op.img = null;
                ...
                case 7:
                    op.img = null;
                    op.func = 'revitalisasi/implementasi/uploadDocument';
                    op.options = {
                        description: true,
                        category: false,
                        preview: false,
        ...
        loadData(){
            return this.$store.dispatch('revitalisasi/implementasi/show', parseInt(this.$route.params.id))
            .then(res=>{
                this.impl = res
        ...
        save(){
            this.$store.dispatch('revitalisasi/implementasi/update', this.impl)
            .then(()=>{
                this.$success('Data Implementasi berhasil disimpan')
                this.$router.push({name:'revitalisasi_implementasi'})
            })
        }
    },
    computed:{
