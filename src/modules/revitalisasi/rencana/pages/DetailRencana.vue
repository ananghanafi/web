    ...
    <v-layout column>
        <v-flex xs12>
            ...
            <v-card>       
                                                ...
                                                <v-layout row wrap>
                                                    <v-flex md12>
                                                        <v-card color="secondary" tile>
                                                            <v-card-text>PERENCANAAN KEGIATAN REVITALISASI</v-card-text>
                                                        </v-card>
                                                    </v-flex>
                                                    <v-flex md4>
                                                        <v-text-field
                                                    ...
                                                    <v-flex md3>
                                                        <v-text-field v-model="doc.r11Unit" label="Sumur Bor" suffix="unit" disabled></v-text-field>
                                                    </v-flex>
                                                    <v-flex md3>
                                                        <v-text-field v-model="doc.r12Unit" label="Sekat Kanal" suffix="unit" disabled></v-text-field>
                                                    </v-flex>
                                                    <v-flex md3>
                                                        <v-text-field v-model="doc.r13M" label="Penimbunan Kanal" suffix="meter" disabled></v-text-field>
                                                    </v-flex>
                                                    <v-flex md3>
                                                        <v-text-field v-model="doc.r14Unit" label="Embung" suffix="unit" disabled></v-text-field>
                                                    </v-flex>
                                                    <v-flex md4>
                                                        <v-text-field v-model="doc.r21Ha" label="Suksesi Alami" suffix="Ha" disabled></v-text-field>
                                                    </v-flex>
                                                    <v-flex md4>
                                                        <v-text-field v-model="doc.r22Ha" label="Pengkayaan" suffix="Ha" disabled></v-text-field>
                                                    </v-flex>
                                                    <v-flex md4>
                                                        <v-text-field v-model="doc.r23Ha" label="Penanaman Pola Maks" suffix="Ha" disabled></v-text-field>
                                                    </v-flex>
                                                    <v-flex md12>
                                                        <v-card color="secondary" tile>
                ...
                <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="primary" flat @click.native="$router.push({name:'revitalisasi_rencana'})">Batal</v-btn>
...
export default {
    ...
    methods:{
        loadData(){
            return this.$store.dispatch('revitalisasi/perencanaan/show', parseInt(this.$route.params.id))
            .then(res=>{
                this.plan = res
        ...
        save(){
            this.$store.dispatch('revitalisasi/perencanaan/update', this.plan)
            .then(()=>{
                this.$success('Data Perencanaan berhasil disimpan')
                this.$router.push({name:'revitalisasi_rencana'})
            })
        }
    },
    computed:{
