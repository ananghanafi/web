                        ...
                        <v-tabs v-model="tab" fixed>
                                            ...
                                            <v-layout v-if="doc" row wrap>
                                                <v-flex md6>
                                                    <v-layout row wrap>
                                                        ...
                                                        <v-flex md4> 
                                                            <v-text-field v-model="impl.generalActivity.vegetationDensity.density" label="KERAPATAN VEGETASI" disabled></v-text-field>
                                                        </v-flex>
                                                        <v-flex md4> 
                                                            <v-text-field v-model="impl.generalActivity.vegetationDensity.landCover" label="TUTUPAN LAHAN" disabled></v-text-field>
                                                        </v-flex>
                                                        <v-flex md4>
                                                            <v-text-field v-model="impl.generalActivity.totalArea" label="LUAS AREA" suffix="Ha"></v-text-field>
                                                        </v-flex>
                                                        <v-flex md12>
                                                            <v-card color="secondary" tile>
                            ...
                            <v-tab-item>
                                <v-card flat dense>
                                    ...
                                    <ProgressRealisasi module="revegetasi" :item="impl"/>                                
                                </v-card>
                            </v-tab-item>
                            <!-- Dokumentasi   -->
                            <v-tab-item>
                                <Gallery :item="impl" module="revegetasi"/>
                            </v-tab-item>
                        </v-tabs>                    
                    </v-card-text>
                    <v-card-actions>
...
export default {
    ...
    methods:{
        ...
        loadData(){
            return this.$store.dispatch('revegetasi/implementasi/show', parseInt(this.$route.params.id))
            .then(res=>{
                this.impl = res
        ...
        save(){
            this.$store.dispatch('revegetasi/implementasi/update', this.impl)
            .then(()=>{
                this.$success('Data Implementasi berhasil disimpan')
                this.$router.push({name:'revegetasi_implementasi'})
            })
        }
    },
    computed:{
